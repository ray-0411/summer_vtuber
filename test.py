...
if __name__ == "__main__":
    ...
    test_yt_url = "https://www.youtube.com/@OumuaXDFP/streams"  # 替換為實際的 YouTube 直播連結
    ...
    #youtube_find_and_crop(test_save_path, "find/yt_find.png", crop_path,45,crop_height=100,crop_width=420)
